...
export default function OverlayModal({
  ...
  // area to almost nothing AND clips the input behind the keyboard. Fix:
  // when the keyboard is up, GROW the sheet to fill all vertical space
  // above the keyboard so the list keeps its room and the input sits flush
  ...
  const sheetHeight = (() => {
    ...
    if (keyboardHeight > 0) {
      ...
      // top margin so the sheet doesn't reach the status bar.
